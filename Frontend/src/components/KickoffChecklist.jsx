...
const KickoffChecklist = ({ projectId, onComplete }) => {
  const [items, setItems] = useState([
    {
      id: 1,
      text: "Scope and assets verified",
      icon: <FiTarget />,
      checked: false,
    },
    {
      id: 2,
      text: "Engagement rules & MNDA signed",
      icon: <FiFileText />,
      checked: false,
    },
    {
      id: 3,
      text: "Compliance tags and environment ready",
      icon: <FiShield />,
      checked: false,
    },
    {
      id: 4,
      text: "Hacker team finalized and briefed",
      icon: <FiBox />,
      checked: false,
    },
  ]);
  ...
  return (
    <div className="bg-[#00c477]/5 border border-[#00c477]/20 rounded-2xl p-6 shadow-xl shadow-[#00c477]/5">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h3 className="font-bold text-[#00c477] uppercase tracking-widest font-mono">
            Engagement Kickoff
          </h3>
          <p className="text-xs text-gray-400">
            Perform these mandatory checks to transition from Planning to
            Execution.
          </p>
        </div>
      </div>
          ...
          >
            ...
            <div
              className={`h-5 w-5 rounded-md border flex items-center justify-center ${
                item.checked
                  ? "bg-[#00c477] border-[#00c477] text-black"
                  : "border-white/20"
              }`}
            >
