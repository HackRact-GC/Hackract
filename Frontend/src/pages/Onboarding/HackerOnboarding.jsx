...
const HackerOnboarding = () => {
  ...
  const [form, setForm] = useState({
    bio: "",
    skills:
      "API Testing, Vulnerability Assessment, Web Application, Ethical Hacking, OWASP",
    certifications: [],
    education: [],
    employment: [],
    other: [],
  ...
  const saveProfile = async (finalStatus) => {
    try {
      const payload = {
        ...
        employment: form.employment.map((e) =>
          JSON.stringify({
            company: e.company,
            title: e.title,
            from: e.from,
        ...
        otherExperiences: form.other.map((o) =>
          JSON.stringify({
            subject: o.subject,
    ...
    <div className="min-h-screen bg-[#050505] text-white p-4 lg:p-8 font-sans">
      <div className="max-w-[1200px] mx-auto space-y-6">
        ...
        <div className="bg-[#0c0c0c] border border-[#00c477]/30 rounded-2xl p-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <div>
            <h1 className="text-2xl font-bold text-[#00c477]">
              Complete Your Operator Profile
            </h1>
            <p className="text-gray-400 text-sm">
              Provide your details to unlock the mission dashboard.
            </p>
          </div>
          <button
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center bg-[#0c0c0c] border border-white/5 rounded-2xl p-6">
          <div className="flex items-center gap-6">
            <div className="relative group">
              <div
                className="w-24 h-24 rounded-full bg-gradient-to-br from-[#111] to-[#050505] border border-white/10 flex items-center justify-center overflow-hidden cursor-pointer"
              ...
              >
                {logoPreview ? (
                  ...
                  <span className="text-2xl font-black text-[#00c477]">
                    {initials}
                  </span>
                )}
          ...
          <div className="space-y-6">
              ...
              {isNationalIdVerified ? (
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <button
                    ...
                    className="w-8 h-8 rounded-full border border-white/20 flex items-center justify-center hover:bg-white/10 text-[#00c477]"
                  >
                    <FiPlus size={16} />
                  </button>
                </div>
            ...
            <div className="bg-[#0c0c0c] border border-white/5 rounded-2xl p-6 relative group">
              ...
              <button
                ...
                className="absolute top-6 right-6 w-8 h-8 rounded-full border border-[#00c477] flex items-center justify-center hover:bg-[#00c477]/10 text-[#00c477] opacity-0 group-hover:opacity-100 transition-opacity"
              >
                <FiPlus size={14} />
              </button>
              ...
              {editMode.education ? (
                <div className="space-y-3 mt-4 border-b border-white/5 pb-4 mb-4">
                  <input
                    ...
                    className="w-full bg-[#111] border border-[#00c477] rounded-lg p-2 text-sm focus:outline-none"
                  />
                  <input
                    type="text"
                    placeholder="Area of Study (Degree)"
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="w-1/2 bg-[#111] border border-[#00c477] rounded-lg p-2 text-sm focus:outline-none"
                    />
                    <input
                      type="text"
                  ...
                  <div className="flex gap-2 pt-2">
                    <button
                      ...
                      className="px-3 py-1 bg-[#00c477] text-black text-xs rounded-full font-bold"
                    >
                      Add & Done
                    </button>
                    <button
                      onClick={() => toggleEdit("education")}
                      className="px-3 py-1 bg-white/10 text-white text-xs rounded-full font-bold hover:bg-white/20"
                    >
                      Cancel
                    </button>
                  </div>
              ...
              <div className="space-y-4">
                {form.education.length > 0 ? (
                  form.education.map((edu, idx) => (
                    <div
                      key={idx}
                      className="group/item relative border-b border-white/5 pb-4 last:border-0 last:pb-0"
                    >
                      ...
                      <button
                        ...
                        className="absolute top-0 right-0 hidden group-hover/item:flex w-6 h-6 rounded-full bg-red-500/10 text-red-500 items-center justify-center hover:bg-red-500 hover:text-white"
                      >
                        <FiTrash2 size={12} />
                      </button>
                    </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#0c0c0c] border border-white/5 rounded-2xl p-6 lg:p-8 space-y-6">
              <div className="relative group">
                ...
                <button
                  ...
                  className="absolute -top-1 right-0 w-8 h-8 rounded-full border border-[#00c477] flex items-center justify-center hover:bg-[#00c477]/10 text-[#00c477] opacity-0 group-hover:opacity-100 transition-opacity"
                >
                  <FiEdit2 size={14} />
                </button>
                ...
                {editMode.identity ? (
                  <div className="w-full space-y-3">
                    ...
                    <input
                      type="text"
                      placeholder="Specialization (e.g. Web Exploitation)"
                    ...
                    <div className="mt-2">
                      <button
                        ...
                        className="px-4 py-1.5 bg-[#00c477] text-black text-sm rounded-full font-bold"
                      >
                        Save
                      </button>
                    </div>
                ...
                {editMode.bio ? (
                  <div className="w-full">
                    <textarea
                      ...
                      className="w-full bg-[#111] border border-[#00c477] rounded-lg p-4 min-h-[150px] text-sm focus:outline-none resize-none"
                      placeholder="Greetings 👋! I'm..."
                    ></textarea>
                    <div className="mt-2">
                      <button
            ...
            <div className="bg-[#0c0c0c] border border-white/5 rounded-2xl p-6 lg:p-8 relative group">
              ...
              <button
                ...
                className="absolute top-6 right-8 w-8 h-8 rounded-full border border-[#00c477] flex items-center justify-center hover:bg-[#00c477]/10 text-[#00c477] opacity-0 group-hover:opacity-100 transition-opacity"
              >
                <FiEdit2 size={14} />
              </button>
              ...
              {editMode.skills ? (
                <div>
                  <textarea
                    ...
                    className="w-full bg-[#111] border border-[#00c477] rounded-lg p-4 text-sm focus:outline-none"
                ...
                <div className="flex flex-wrap gap-2">
                  {form.skills
                    ...
                    .map((skill, idx) => (
                      <span
                        key={idx}
                        className="px-4 py-1.5 bg-white/5 border border-white/10 text-gray-300 rounded-full text-sm hover:bg-white/10 transition-colors cursor-default"
                      >
                        {skill}
                      </span>
                    ))}
            ...
            <div className="bg-[#0c0c0c] border border-white/5 rounded-2xl p-6 lg:p-8 relative group">
              <div className="flex justify-between items-center mb-6">
                ...
                <button
                  ...
                  className="w-8 h-8 rounded-full border border-[#00c477] flex items-center justify-center hover:bg-[#00c477]/10 text-[#00c477] opacity-0 group-hover:opacity-100 transition-opacity"
                >
                  <FiPlus size={16} />
                </button>
              </div>
              ...
              {editMode.certifications ? (
                <div className="space-y-3 border-b border-white/5 pb-4 mb-4">
                  ...
                  <input
                    ...
                    value={newItem.certNumber || ""}
                    onChange={(e) =>
                      setNewItem({ ...newItem, certNumber: e.target.value })
                    }
                    className="w-full bg-[#111] border border-[#00c477] rounded-lg p-2 text-sm focus:outline-none"
                  />
                  <input
                    type="text"
                    placeholder="Provider (e.g. Offensive Security)"
                    value={newItem.provider || ""}
                    onChange={(e) =>
                      setNewItem({ ...newItem, provider: e.target.value })
                    }
                    className="w-full bg-[#111] border border-[#00c477] rounded-lg p-2 text-sm focus:outline-none"
                  />
                    ...
                    <input
                      ...
                      onChange={async (e) => {
                        ...
                        if (file) {
                          ...
                          try {
                            const { uploadFile } =
                              await import("../../api/uploadService.js");
                  ...
                  <div className="flex gap-2 pt-2">
                    ...
                    <button
                      onClick={() => toggleEdit("certifications")}
                      className="px-4 py-1.5 bg-white/10 text-white text-sm rounded-full font-bold hover:bg-white/20"
                    >
                      Cancel
                    </button>
                  </div>
              ...
              <div className="space-y-6">
                {form.certifications.length > 0 ? (
                  form.certifications.map((cert, idx) => (
                    <div
                      key={idx}
                      className="flex gap-4 group/item relative border-b border-white/5 pb-4 last:border-0 last:pb-0"
                    >
                      ...
                      <div>
                        ...
                        {cert.file && (
                          <p className="text-xs text-[#00c477] mt-1 flex items-center gap-1">
                            <FiFolder size={12} /> Attached: {cert.file}
                          </p>
                        )}
                      </div>
                      <button
                    ...
                    >
                      ...
                      <button
                        onClick={() =>
                          setForm({
                            ...form,
                            employment: form.employment.filter(
                              (_, i) => i !== idx,
                            ),
                          })
                        }
              ...
              {editMode.other ? (
                <div className="space-y-3 border-b border-white/5 pb-4 mb-4">
                  ...
                  <textarea
                    ...
                    className="w-full bg-[#111] border border-[#00c477] rounded-lg p-2 text-sm focus:outline-none resize-none min-h-[80px]"
                  />
                  <div className="flex items-center gap-2">
                    <span className="text-sm text-gray-400">
                      Upload Photo/File:
                ...
                {form.other.length > 0 ? (
                  form.other.map((exp, idx) => (
                    ...
                    >
                      ...
                      <p className="text-sm text-gray-300 pr-10">
                        {exp.description}
                      </p>
                      {exp.file && (
                        <p className="text-xs text-[#00c477] mt-2 flex items-center gap-1">
                          <FiFolder size={12} /> Attached: {exp.file}
                        </p>
                      )}
                      <button
                        onClick={() =>
                          setForm({
                            ...form,
                            other: form.other.filter((_, i) => i !== idx),
                          })
                        }
                        className="absolute top-0 right-0 hidden group-hover/item:flex w-8 h-8 rounded-full bg-red-500/10 text-red-500 items-center justify-center hover:bg-red-500 hover:text-white"
                      >
                  ...
                  <div className="flex flex-col items-center justify-center text-center py-6 text-gray-500">
                    ...
                    <button
                      onClick={() => toggleEdit("other")}
                      className="text-sm text-[#00c477] hover:underline"
                    >
                      Add an experience
                    </button>
                  </div>
