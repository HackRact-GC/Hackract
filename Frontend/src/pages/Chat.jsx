...
export default function Chat() {
    ...
    async (payload, editingMsg) => {
      ...
      try {
        ...
        import("react-hot-toast").then((t) =>
          t.default.error("Failed to send message."),
        );
      }
    },
    [active, replyTo, user],
  ...
  return (
    <div
      className="flex h-full bg-[#0d0d0d] overflow-hidden"
        ...
        <div className="flex-1 flex flex-col min-w-0 bg-[#0d0d0d]">
          ...
          <div className="px-6 py-3.5 border-b border-white/[0.05] flex items-center justify-between bg-[#0d0d0d]/80 backdrop-blur-xl shrink-0">
            <div className="flex items-center gap-3">
              {active.type === "GROUP" ? (
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#00c477]/20 to-purple-500/20 border border-white/10 flex items-center justify-center text-white font-bold text-sm">
              ...
              <div>
                ...
                <p className="text-xs font-mono mt-px">
                  {active.type === "GROUP" ? (
                    ...
                    <span className="text-[#00c477]">online now</span>
                  ) : (
                    <span className="text-gray-600">
          ...
          <div
            ...
            style={{
              backgroundImage:
                "radial-gradient(ellipse at 50% 0%, rgba(0,196,119,0.025) 0%, transparent 65%)",
            }}
          >
            {hasMore && (
              <div className="flex justify-center py-1">
                <button
                  ...
                  className="text-[#00c477]/70 hover:text-[#00c477] text-xs font-mono transition-colors disabled:opacity-40"
                >
            ...
            {loadingMsgs && messages.length === 0 ? (
              <div className="flex items-center justify-center h-full">
                <div className="w-6 h-6 border-2 border-[#00c477]/30 border-t-[#00c477] rounded-full animate-spin" />
              </div>
            ) : (
              <>
                    ...
                    <Avatar
                      user={
                        active.participants?.find(
                          (p) => p.userId === typingIds[0],
                        )?.user
                      }
                      size={32}
                    />
                    <div className="bg-[#1c1c1c] border border-white/[0.06] rounded-2xl rounded-bl-[6px] px-4 py-2">
                      <TypingDots />
                    </div>
                  </div>
                )}
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 font-mono leading-relaxed">
                Real-time secure messaging between organizations and security
                researchers. Send text, images, files, voice and video.
              </p>
            </div>
