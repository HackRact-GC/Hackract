...
const HACKER_FEATURES = [
  {
    ...
    desc: "Visual workflow for planning and executing tests",
  },
  {
    label: "AI Guidance",
    desc: "AI guidance and automation for faster results",
  },
  {
    label: "Integrated Tools",
    desc: "Integrated tools and terminal in one place",
  },
  {
    label: "Collaboration",
    desc: "Real-time collaboration and shareable profiles",
  },
];
...
const ORG_FEATURES = [
  ...
  {
    label: "AI Insights",
    desc: "AI-powered insights and vulnerability explanations",
  },
  {
    label: "Automated Testing",
    desc: "Automated security testing and monitoring",
  },
  {
    label: "Hacker Management",
    desc: "Hire and manage skilled hackers easily",
  },
];
...
const VideoMockup = () => (
  <div
    style={{
      ...
      boxShadow:
        "0 0 80px rgba(0,255,157,0.08), 0 40px 120px rgba(0,0,0,0.7), inset 0 1px 0 rgba(255,255,255,0.06)",
      overflow: "hidden",
    }}
  >
    {/* Top bar */}
    ...
    <div
      style={{
        ...
        paddingBottom: "52%",
        background:
          "linear-gradient(145deg, #0a0e0a 0%, #080d08 60%, #0c110c 100%)",
      }}
    >
      {/* Grid lines */}
      <div
      ...
      >
        <polyline
          points="0,330 80,290 160,310 240,260 320,280 400,210 480,240 560,180 640,200 720,140 800,160 860,120"
          fill="none"
          stroke="rgba(0,255,157,0.25)"
          strokeWidth="1.5"
        />
        <polyline
          points="0,380 80,360 160,370 240,340 320,355 400,310 480,330 560,290 640,310 720,265 800,280 860,250"
          fill="none"
        ...
        <polygon
          points="0,330 80,290 160,310 240,260 320,280 400,210 480,240 560,180 640,200 720,140 800,160 860,120 860,430 0,430"
          fill="url(#chartFill)"
        />
      </svg>
      ...
      <div
        style={{
          ...
          boxShadow:
            "0 0 40px rgba(0,255,157,0.25), inset 0 0 20px rgba(0,255,157,0.08)",
          cursor: "pointer",
        }}
      >
...
const Landing = () => {
  ...
  const glassCard = (extra = {}) => ({
    ...
    borderRadius: 16,
    boxShadow:
      "0 0 40px rgba(0,255,157,0.04), inset 0 1px 0 rgba(255,255,255,0.05), 0 20px 60px rgba(0,0,0,0.5)",
    ...extra,
  });
    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(0,255,157,0.055) 0%, transparent 70%)",
          pointerEvents: "none",
          zIndex: 0,
          filter: "blur(40px)",
        }}
      ...
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(0,255,157,0.035) 0%, transparent 70%)",
          pointerEvents: "none",
          zIndex: 0,
          filter: "blur(40px)",
        }}
      ...
      <nav
        style={{
          ...
          background:
            scrollY > 20 ? "rgba(13,13,13,0.85)" : "rgba(13,13,13,0.5)",
          backdropFilter: "blur(24px)",
          WebkitBackdropFilter: "blur(24px)",
          borderBottom: "1px solid rgba(255,255,255,0.04)",
        ...
        <div style={fadeUp(80)}>
          <h1
            style={{
              ...
              marginBottom: 28,
              background:
                "linear-gradient(180deg, #ffffff 0%, rgba(200,220,200,0.75) 100%)",
          ...
          >
            A <span style={{ color: "#00ff9d", fontWeight: 600 }}>unifies</span>{" "}
      ...
      <section
        id="protocols"
        style={{ position: "relative", zIndex: 1, padding: "100px 40px" }}
      >
                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      justifyContent: "center",
                      boxShadow:
                        "0 0 40px rgba(0,255,157,0.1), inset 0 0 30px rgba(0,255,157,0.04)",
                      marginBottom: 24,
                      position: "relative",
                    }}
                  >
                  ...
                  >
                    <div
                      style={{
                        ...
                        height: 1,
                        background:
                          "linear-gradient(90deg, rgba(0,255,157,0.3), rgba(0,255,157,0.1))",
                      }}
                    />
                    <div
                      style={{
                    ...
                    <div
                      style={{
                        ...
                        height: 1,
                        background:
                          "linear-gradient(90deg, rgba(0,255,157,0.1), rgba(0,255,157,0.3))",
                      }}
                    />
                  </div>
                )}
      ...
      ════════════════════════════════════════════════════════════════ */}
      <section
        style={{ position: "relative", zIndex: 1, padding: "60px 40px 100px" }}
      >
        <div
          style={{
            maxWidth: 1100,
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                textTransform: "uppercase",
                color: "#000",
                background: "linear-gradient(135deg,#00ff9d,#00e38b)",
                border: "none",
                borderRadius: 10,
                padding: "12px 28px",
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          >
            ...
            <div>
              ...
              <p
                style={{
                  fontFamily: "'Inter',sans-serif",
                  fontSize: 11,
                  color: "rgba(120,150,120,0.6)",
                  lineHeight: 1.7,
                  maxWidth: 220,
                }}
              >
                AI-powered penetration testing platform for elite security
                operators.
              </p>
              <p
                style={{
            ...
            {[
              {
                heading: "Resources",
                links: ["Docs", "API Ref", "Changelog", "Status"],
              },
              {
                heading: "Connect",
                ...
                >
                  {col.links.map((link) => (
                    <a
                      ...
                      style={{ fontSize: 12, color: "rgba(140,170,140,0.6)" }}
                    >
                      {link}
                    </a>
                  ))}
