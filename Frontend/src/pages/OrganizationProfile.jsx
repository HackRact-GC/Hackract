  ...
  Building: () => (
    ...
    >
      <path
        ...
        d="M3 21h18M9 21V7l6-4v18M9 7H3v14M15 21V11"
      />
    </svg>
  ),
  Camera: () => (
  ...
  Gavel: () => (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M14 13l-4 4m-3.5-3.5a2.828 2.828 0 0 1 4-4L18.6 1.4a1.414 1.414 0 0 1 2 2L12.5 11.5a2.828 2.828 0 0 1-4 4L2.4 21.6a1.414 1.414 0 0 1-2-2L6.5 13.5z"
      />
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 21h6M15 21h6" />
    </svg>
  ),
  User: () => (
    <svg
  ...
  <div className="bg-[#141518] border border-white/5 rounded-xl overflow-hidden mb-6">
    <div className="px-6 py-4 flex items-center justify-between border-b border-white/5">
      <div className="flex items-center gap-3 text-[#00c477]">
        <IconComp />
        <h3 className="text-[11px] font-mono font-bold uppercase tracking-[0.2em]">
          {title}
        </h3>
      </div>
...
export default function OrganizationProfile() {
      ...
      try {
        ...
        if (orgs?.length > 0) {
          ...
          setForm({
            ...
            licenseIssueDate: org.licenseIssueDate || "",
            ...
            contactJobTitle: org.contactJobTitle || "",
            contactLinkedin: org.contactLinkedin || "",
            logoUrl: org.logoUrl || "",
            slug: org.slug || "",
          });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (
        ...
        toast.error(
          `${firstError.message || `Validation failed for field: ${firstError.field}`}`,
        );
      } else {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#0a0a0c] flex items-center justify-center text-[#00c477] font-mono">
        Loading...
      </div>
    );
  }
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Field label="Industry">
              <Input
                ...
                value={form.industry}
                onChange={handleChange}
                placeholder="Technology / Cyber Security"
              />
            </Field>
            <Field label="Company Type">
              <Input
                ...
                onChange={handleChange}
                placeholder="Private Enterprise"
              />
            </Field>
          ...
          <div className="mt-6">
            <Field label="Street Address">
              <Input
                ...
                onChange={handleChange}
                placeholder="Bole Road, Dembel City Center, 5th Floor"
              />
            </Field>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
            ...
            <Field label="Maps Link">
              <div className="relative flex items-center">
                <span className="absolute left-3 text-[#00c477]">
                  <Icons.Link />
                </span>
                <Input
                  name="mapsLink"
                  value={form.mapsLink}
                  onChange={handleChange}
                  className="w-full border border-white/10 rounded-sm bg-white/[0.02] text-sm text-[#00c477] placeholder-gray-600 focus:outline-none focus:border-[#00c477]/50 transition-all font-mono pl-9 pr-4 py-3"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Field label="Business Registration Number">
              <Input
                ...
                onChange={handleChange}
                placeholder="MT/AA/1/00123/2018"
              />
            </Field>
            <Field label="License Issue Date">
              <Input
                ...
                onChange={handleChange}
                className="w-full border border-white/10 rounded-sm bg-white/[0.02] text-sm text-gray-400 focus:outline-none focus:border-[#00c477]/50 transition-all font-mono px-4 py-3 [&::-webkit-calendar-picker-indicator]:filter [&::-webkit-calendar-picker-indicator]:invert"
              />
            </Field>
            ...
            <Field label="Business License">
              <div className="mt-1 flex flex-col gap-3">
                ...
                {licenseFile || form.businessLicenseUrl ? (
                  <div className="flex items-center justify-between border border-white/10 rounded-lg p-4 bg-[#0a0a0c]">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <button
                        type="button"
                        className="text-gray-500 hover:text-white transition-colors bg-white/5 p-2 rounded"
                      >
                        <Icons.Eye />
                      </button>
                      <button
                ...
                <button
                  ...
                  className="self-start text-xs font-mono text-[#00c477] hover:underline"
                >
                  {form.businessLicenseUrl || licenseFile
                    ? "Replace File"
                    : "+ Upload Document"}
                </button>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Field label="Work Email">
              <Input
                ...
                onChange={handleChange}
                placeholder="abebe.k@acmecorp.com"
              />
            </Field>
            ...
            <Field label="LinkedIn Profile">
              <div className="relative flex items-center">
                ...
                <Input
                  ...
                  onChange={handleChange}
                  className="w-full border border-white/10 rounded-sm bg-white/[0.02] text-sm text-[#00c477] placeholder-gray-600 focus:outline-none focus:border-[#00c477]/50 transition-all font-mono pl-9 pr-4 py-3"
                  placeholder="linkedin.com/in/abekebede"
                />
              </div>
            </Field>
          </div>
