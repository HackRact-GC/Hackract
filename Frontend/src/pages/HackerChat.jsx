        ...
        <div className="flex-1 flex flex-col min-w-0 bg-[#0d0d0d]">
          ...
          <div className="px-6 py-3.5 border-b border-white/5 flex items-center justify-between bg-[#0d0d0d]/80 backdrop-blur-xl shrink-0">
            <div className="flex items-center gap-3">
              {active.type === "GROUP" ? (
                <div className="w-10 h-10 rounded-xl bg-linear-to-br from-[#00c477]/20 to-purple-500/20 border border-white/10 flex items-center justify-center text-white font-bold text-sm">
                ...
                {typingIds.length > 0 && (
                  <div className="flex items-end gap-2.5">
                    <Avatar
                      ...
                      size={32}
                    />
                    <div className="bg-[#1c1c1c] border border-white/6 rounded-2xl rounded-bl-[6px] px-4 py-2">
                      <TypingDots />
                    </div>
                  </div>
                )}
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 font-mono leading-relaxed">
                Secure communication with organizations. Discuss findings,
                scope, and rewards in real-time.
              </p>
            </div>
          </motion.div>
        </div>
