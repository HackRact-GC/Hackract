        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-1 space-y-6">
            <div className="bg-white/5 border border-white/10 p-6 rounded-2xl flex flex-col items-center text-center">
              ...
              <p className="text-[#00c477] font-mono text-sm mt-1">
                /{org.slug}
              </p>

              <div className="w-full mt-6 pt-6 border-t border-white/10 text-left space-y-3">
                <div>
                  <p className="text-gray-500 text-xs font-mono uppercase text-center mb-2 justify-center flex items-center gap-1">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="text-gray-200 font-mono text-sm text-center block truncate hover:text-[#00c477] transition-colors"
                  >
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <div className="bg-yellow-500/10 border border-yellow-500/20 p-6 rounded-2xl relative overflow-hidden">
              ...
              <p className="text-gray-400 text-xs mb-4">
                Validate this identifier against local tax registries before
                approving.
              </p>
