...
const HackerVerification = () => {
  ...
  const handleSign = async (title) => {
    setSigning(true);
    try {
      await api.post("/hacker-profiles/me/sign-agreement", {
  ...
  if (loading)
    return (
      <div className="min-h-screen bg-[#050505] flex items-center justify-center font-mono">
        <div className="text-[#00c477] animate-pulse">
          INITIATING_VERIFICATION_CHECK...
        </div>
      </div>
    );
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="flex items-center justify-between border-b border-white/10 pb-6">
          <div className="flex items-center gap-4">
            <div
              className={`h-12 w-12 rounded-xl flex items-center justify-center text-2xl ${isApproved ? "bg-[#00c477]/20 text-[#00c477]" : "bg-amber-500/20 text-amber-500"}`}
            >
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">
                Legally certify your status to join high-stakes engagements.
              </p>
            </div>
          </div>
          <div
        ...
        {isApproved && (
          <div className="bg-[#00c477]/10 border border-[#00c477]/30 p-4 rounded-xl flex items-center gap-4">
            ...
            <p className="text-sm text-[#00c477]">
              Your operator status is <strong>APPROVED</strong>. You have full
              access to organization projects and AI-augmented tools.
            </p>
          </div>
        )}
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 space-y-4">
              ...
              <div className="space-y-3">
                {[
                  ...
                  return (
                    <div
                      key={title}
                      className={`p-4 rounded-xl border transition-all ${isSigned ? "bg-[#00c477]/5 border-[#00c477]/20" : "bg-amber-500/5 border-amber-500/20"}`}
                    >
                      <div className="flex items-center justify-between mb-2">
                        <span
                          className={`text-[10px] font-mono tracking-tighter uppercase px-2 py-0.5 rounded ${isSigned ? "bg-[#00c477]/20 text-[#00c477]" : "bg-amber-500/20 text-amber-500"}`}
                        >
              ...
              <div className="p-4 bg-amber-500/5 border border-amber-500/20 rounded-xl space-y-2">
                ...
                <p className="text-[10px] text-gray-400 leading-relaxed">
                  Participation in organization-hosted pentests requires a valid
                  MNDA. Unauthorized testing or data leakage will result in
                  immediate legal action and platform ban.
                </p>
              </div>
            </div>
          </div>
