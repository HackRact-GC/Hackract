        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="bg-transparent">
            ...
            <div className="space-y-4 relative before:absolute before:inset-0 before:ml-[11px] before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-[2px] before:bg-gradient-to-b before:from-transparent before:via-white/10 before:to-transparent">
              {[
                { type: 'scan', color: 'bg-[#41D1FF]', title: `AI Agent system online and tracking ${activeProjects} projects.`, time: 'Just now' },
                { type: 'alert', color: criticalVulns > 0 ? 'bg-red-500 shadow-[0_0_10px_rgba(239,68,68,0.5)]' : 'bg-green-500', title: criticalVulns > 0 ? `New <span class="text-red-400 font-bold">CRITICAL</span> vulnerability detected across nodes.` : `All systems reporting stable operations.`, time: 'Recent' },
                { type: 'assign', color: 'bg-[#b490ff]', title: `Operative <strong>${displayName}</strong> dashboard loaded successfully.`, time: 'Today' },
              ].map((item, i) => (
