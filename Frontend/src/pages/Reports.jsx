...
const CheckboxOption = ({ id, label, checked, onChange }) => (
  ...
  >
    ...
    <div
      className={`w-5 h-5 flex items-center justify-center rounded-md border transition-colors ${checked ? "bg-[#00c477] border-[#00c477]" : "bg-[#1e1e24] border-gray-600"}`}
    >
      {checked && (
        <svg
        ...
        <div className="max-w-2xl">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-gray-300 text-sm font-medium leading-relaxed">
              Configure and synthesize high-fidelity audit reports for the{" "}
              <span className="font-bold text-white uppercase">
                {projectName}
              </span>{" "}
              architecture. Select parameters, review findings, and deploy
              documentation.
            </h1>
          </div>
        </div>
      ...
      <div className="flex flex-1 p-8 gap-8 max-w-[1600px] mx-auto w-full">
        ...
        <div className="flex-1 max-w-[700px] flex flex-col gap-6">
          ...
          <div className="flex gap-2 mb-2">
            <div
              className={`h-1 flex-1 rounded-full ${step >= 1 ? (step === 1 ? "bg-linear-to-r from-[#00c477] to-[#1c1d21]" : "bg-[#00c477]") : "bg-[#1c1d21]"}`}
            />
            <div
              className={`h-1 flex-1 rounded-full ${step >= 2 ? (step === 2 ? "bg-linear-to-r from-[#00c477] to-[#1c1d21]" : "bg-[#00c477]") : "bg-[#1c1d21]"}`}
            />
            <div
              className={`h-1 flex-1 rounded-full ${step >= 3 ? (step === 3 ? "bg-linear-to-r from-[#00c477] to-[#1c1d21]" : "bg-[#00c477]") : "bg-[#1c1d21]"}`}
            />
          </div>
          ...
          {step === 1 && (
            <>
              ...
              <div className="bg-[#0f1115] border border-[#1c1d21] rounded-2xl p-6 flex-1 flex flex-col">
                <div className="mb-8">
                  <h3 className="text-[10px] font-bold text-gray-500 uppercase tracking-widest font-mono mb-4">
                    Target Project
                  </h3>
                  <select
                    value={projectId || ""}
                ...
                <div className="grid grid-cols-2 gap-4">
                  <button
                    ...
                    className={`p-6 rounded-xl border flex flex-col items-center gap-4 transition-all ${exportFormat === "pdf" ? "border-[#00c477] bg-[#00c477]/10 text-[#00c477]" : "border-white/5 bg-[#141518] hover:border-white/20 text-gray-400"}`}
                  >
                    <FiFileText size={32} />
                  ...
                  <button
                    ...
                    className={`p-6 rounded-xl border flex flex-col items-center gap-4 transition-all ${exportFormat === "json" ? "border-[#00c477] bg-[#00c477]/10 text-[#00c477]" : "border-white/5 bg-[#141518] hover:border-white/20 text-gray-400"}`}
                  >
                    <FiCode size={32} />
                    <span className="font-bold tracking-widest uppercase">
                      JSON Payload
                ...
                <div className="flex gap-4 mt-auto pt-6">
                  <button
                    onClick={() => navigate(-1)}
                    className="px-6 py-3.5 rounded-xl border border-white/10 text-xs font-bold text-gray-300 uppercase tracking-widest hover:bg-white/5 transition-colors"
                  >
                    Cancel
                  </button>
                  <button
              ...
              <div className="bg-[#0f1115] border border-[#1c1d21] rounded-2xl p-6 flex-1 flex flex-col">
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                  <CheckboxOption
                    ...
                    checked={modules.execSummary}
                    onChange={() => toggleModule("execSummary")}
                  />
                  <CheckboxOption
                    id="TECH_SCOPE"
                    label="Technical Scope"
                    checked={modules.techScope}
                    onChange={() => toggleModule("techScope")}
                  />
                  <CheckboxOption
                    id="FINDINGS_M"
                    label="Vulnerability Matrix"
                    checked={modules.vulnMatrix}
                    onChange={() => toggleModule("vulnMatrix")}
                  />
                  <CheckboxOption
                    id="REMED_PATH"
                    label="Remediation Roadmap"
                    checked={modules.remedPath}
                    onChange={() => toggleModule("remedPath")}
                  />
                </div>
                ...
                <div className="mb-8">
                  <h3 className="text-[10px] font-bold text-gray-500 uppercase tracking-widest font-mono mb-4">
                    Advanced_Metadata_Injection
                  </h3>
                  <div className="space-y-1">
                    <ToggleSwitch
                      label="Include Evidence Screenshots"
                      icon={FiFileText}
                      checked={modules.screenshots}
                      onChange={() => toggleModule("screenshots")}
                    />
                    <ToggleSwitch
                      label="CVSS Score Breakdown"
                      icon={FiFileText}
                      checked={modules.cvssBreakdown}
                      onChange={() => toggleModule("cvssBreakdown")}
                    />
                    <ToggleSwitch
                      label="Digital Signature Verification"
                      icon={FiFileText}
                      checked={modules.digitalSignature}
                      onChange={() => toggleModule("digitalSignature")}
                    />
                  </div>
                </div>
                ...
                <div className="flex-1 flex flex-col min-h-[200px]">
                  ...
                  <div className="flex-1 bg-[#141518] border border-[#1c1d21] rounded-xl overflow-hidden flex flex-col">
                    ...
                    <div className="overflow-y-auto flex-1 p-2 space-y-1">
                      {loading ? (
                        <div className="flex justify-center py-8 text-[#00c477]">
                          <FiLoader className="animate-spin" />
                        </div>
                      ) : findings.length === 0 ? (
                        <div className="text-center text-xs text-gray-600 py-8 font-mono">
                        ...
                        findings.slice(0, 6).map((f, i) => (
                          <div
                            key={f.id}
                            className="grid grid-cols-12 gap-2 px-2 py-2.5 items-center hover:bg-white/5 rounded-lg transition-colors cursor-default"
                          >
                            <div className="col-span-2 text-[10px] font-mono text-[#00c477]">
                              #RX-{String(i + 1).padStart(3, "0")}
                            </div>
                            <div
                              className="col-span-6 text-xs text-gray-300 font-medium truncate"
                              title={f.title}
                            >
                              {f.title}
                            </div>
                            <div className="col-span-2 flex justify-center">
                              <span
                                className={`text-[9px] font-black uppercase tracking-widest px-2 py-0.5 rounded border ${getSeverityStyle(f.severity)}`}
                              >
                                {f.severity}
                              </span>
                            </div>
          ...
          {step === 3 && (
            <>
              ...
              <div className="bg-[#0f1115] border border-[#1c1d21] rounded-2xl p-6 flex-1 flex flex-col justify-center items-center text-center">
                <FiSend
                  size={48}
                  className="text-[#00c477] mb-6 animate-pulse"
                />
                ...
                <p className="text-sm text-gray-500 mb-8 max-w-[250px]">
                  All parameters configured. The{" "}
                  {exportFormat === "pdf" ? "PDF document" : "JSON payload"} is
                  ready to be compiled and securely downloaded to your local
                  system.
                </p>
        ...
        <div className="w-[450px] xl:w-[500px] flex flex-col gap-4">
          <div className="bg-[#141518] border border-[#1c1d21] rounded-2xl p-6 flex-1 flex flex-col">
            ...
            <div className="flex-1 bg-[#0a0a0a] rounded-xl overflow-hidden border border-[#2a2b30] shadow-[0_0_50px_rgba(0,0,0,0.5)] flex flex-col p-8 relative">
              ...
              <div className="text-[#00c477] font-black text-lg tracking-[0.2em] mb-2 z-10">
                HACKRACT
              </div>
              <div className="text-gray-500 text-[9px] font-mono tracking-widest uppercase mb-16 z-10">
                SYNTHETIC_SENTINEL_V4.0
              </div>

              <div className="flex-1 flex flex-col justify-center z-10">
                <div className="text-[#00c477] text-[10px] font-black tracking-widest uppercase mb-2">
                  PROJECT_MANIFEST
                </div>
              ...
              <div className="z-10 border-l border-[#00c477]/30 pl-4 mt-auto">
                ...
                <div className="text-xs font-bold text-gray-200 uppercase tracking-wider mb-4">
                  {orgName}{" "}
                  <span className="text-red-500 text-[10px] ml-1 px-1 bg-red-500/20 rounded">
                    LEVEL_9_TOP_SECRET
                  </span>
                </div>

                <div className="text-[8px] font-black text-gray-500 tracking-widest uppercase mb-1">
                  DATE_ISSUED
                </div>
                <div className="text-[10px] font-mono text-gray-300 tracking-widest flex items-center justify-between">
                  <span>{today}</span>
                  <div className="w-4 h-4 text-[#00c477]">
                    <svg
                      viewBox="0 0 24 24"
                      fill="none"
                      stroke="currentColor"
