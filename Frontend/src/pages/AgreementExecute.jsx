...
const stripLetter = (content) => {
  ...
  return (
    content.slice(0, start) + content.slice(end + LETTER_MARKER_END.length)
  ).trim();
};
...
const renderLetterText = (letter) => {
  ...
  const greeting = letter.recipient_name
    ...
    : "";
  const closing = [letter.closing, letter.signer_name]
    .filter(Boolean)
    .join("\n");
...
const formatAgreementType = (value) =>
  AGREEMENT_TYPE_OPTIONS.find((option) => option.value === value)?.label ||
  "Agreement";
...
export default function AgreementExecute() {
  ...
  const isOrg = roleTypes.some((r) =>
    ["ORG_ADMIN", "ORGANIZATION"].includes(r),
  );
  ...
  const handleDownload = () => {
    const content = isOrg
      ...
      : editableContent || agreement?.content || "";
      ...
      try {
        if (id) {
          const [agreementRes, signedRes] = await Promise.all([
            ...
            api
              .get(`/user-signatures/check/${id}`)
              .catch(() => ({ data: { signed: false } })),
          ]);
  ...
  return (
    <div className="min-h-full bg-[#0a0a0a] text-white flex flex-col lg:flex-row overflow-hidden font-sans selection:bg-[#00c477]/30">
              ...
              <div className="relative z-10 text-[15px] leading-[1.9] space-y-5 min-h-32">
                {letter.body ? (
                  ...
                  <p className="text-gray-400 italic">
                    Start writing your letter on the right →
                  </p>
                )}
              </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col relative bg-[#0a0a0a] min-h-[500px]">
        ...
        <div
          className={`flex-1 flex flex-col ${isOrg ? "justify-start py-10 overflow-y-auto custom-scrollbar" : "justify-center"} px-12 lg:px-20 max-w-2xl mx-auto w-full z-10`}
        >
          <MotionDiv
          ...
          >
            ...
            {alreadySigned && !isOrg && (
              <div className="flex items-center gap-3 px-4 py-3 rounded-xl bg-[#00c477]/10 border border-[#00c477]/20 mb-6">
                <svg
                  className="w-4 h-4 text-[#00c477] shrink-0"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="2.5"
                  viewBox="0 0 24 24"
                ...
                <span className="text-xs font-mono text-[#00c477] tracking-widest uppercase">
              ...
              <div className="space-y-5 mb-8">
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-mono text-gray-500 tracking-widest uppercase">
                    Letter Title <span className="text-red-400">*</span>
                  </label>
                  <input
                    type="text"
                    value={editableTitle}
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-[10px] font-mono text-gray-600 tracking-wide">
                    The selected type is shown as a watermark on the preview and
                    PDF.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 gap-4">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateLetter("sender_name", e.target.value)
                      }
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateLetter("sender_address", e.target.value)
                      }
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateLetter("recipient_name", e.target.value)
                    }
                    placeholder="Jane"
                    className="w-full bg-[#111] border border-white/10 rounded-lg px-4 py-3 text-sm text-white placeholder-gray-600 focus:outline-none focus:border-[#00c477]/50 transition-colors"
                  />
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-mono text-gray-500 tracking-widest uppercase">
                    Letter Body <span className="text-red-400">*</span>
                  </label>
                  <textarea
                    value={letter.body}
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateLetter("signer_name", e.target.value)
                    }
                    placeholder="John Doe"
                    className="w-full bg-[#111] border border-white/10 rounded-lg px-4 py-3 text-sm text-white placeholder-gray-600 focus:outline-none focus:border-[#00c477]/50 transition-colors"
                  />
              ...
              <>
                <div className="w-full h-64 bg-[#111111] border border-white/5 rounded-xl mb-8 relative overflow-hidden shadow-[0_0_30px_rgba(0,196,119,0.02)]">
                  <div className="absolute top-4 left-4 flex items-center gap-2 pointer-events-none z-10">
                    ...
                    <span className="text-[10px] font-mono text-[#00c477] tracking-widest">
                      AUTH_TOKEN: #
                      {Math.random().toString(16).slice(2, 6).toUpperCase()}-SEC
                    </span>
                  </div>
                ...
                <label className="flex items-start gap-4 cursor-pointer group mb-10">
                  ...
                  <span className="text-sm text-gray-400 leading-relaxed">
                    I have read and agree to the terms of the Master Services
                    Agreement. I authorize the activation of the{" "}
                    <strong className="text-[#00c477] font-mono font-normal">
                      Hackract AI Agent
                    </strong>{" "}
            ...
            <p className="text-[10px] text-center font-mono text-gray-600 tracking-widest mt-4 uppercase">
              {isOrg
                ? "FRIENDLY LETTER · ENCRYPTED AT REST"
        ...
        <div className="absolute bottom-0 w-full px-6 py-3 border-t border-[#00c477]/10 bg-[#00c477]/5 flex items-center justify-between z-10">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-mono text-[#00c477]">
              {isOrg ? "COMPOSER: Ready" : "AI_Agent: System Ready"}
            </span>
          </div>
