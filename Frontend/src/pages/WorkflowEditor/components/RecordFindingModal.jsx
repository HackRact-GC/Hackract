      ...
      >
        ...
        >
          ...
          <form
            ...
            className="p-6 space-y-6 flex-1 overflow-y-auto max-h-[70vh]"
          >
            {/* Error message */}
            {error && (
            ...
            {/* Title */}
            <div>
              <label className="block text-[10px] text-gray-400 font-bold uppercase tracking-widest mb-2 font-mono">
                Title
              </label>
              <input
                type="text"
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                <label className="text-[10px] text-gray-400 font-bold uppercase tracking-widest font-mono">
                  CVSS Score
                </label>
                <span className="text-[#00ff41] font-mono font-bold text-lg">
                  {formData.cvssScore.toFixed(1)}
                </span>
              </div>
              <input
                type="range"
            ...
            <div>
              ...
              >
                ...
                />
                <div
                  className={`w-12 h-12 rounded-full flex items-center justify-center mb-3 transition-colors ${selectedFiles.length > 0 ? "bg-[#00ff41]/20" : "bg-[#1a1c23] group-hover:bg-[#00ff41]/10"}`}
                >
                  <FiUploadCloud
                    className={`transition-colors ${selectedFiles.length > 0 ? "text-[#00ff41]" : "text-gray-500 group-hover:text-[#00ff41]"}`}
                    size={24}
                  />
                </div>
                {selectedFiles.length > 0 ? (
                  <div className="w-full relative z-10 flex flex-col gap-2">
                    {selectedFiles.map((file, idx) => (
                      <div
                        key={idx}
                        className="flex items-center justify-between bg-black/40 px-3 py-2 rounded-lg border border-[#00ff41]/30 text-left group/file"
                      >
                    ...
                    <p className="text-[10px] text-gray-400 font-mono mt-2">
                      Click or drag more files to append
                    </p>
                  </div>
                ) : (
                  <>
                    ...
                    <p className="text-[10px] text-[#00ff41] font-bold uppercase tracking-widest font-mono">
