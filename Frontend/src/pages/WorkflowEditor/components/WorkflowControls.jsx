...
import { FiLock, FiMaximize, FiMinus, FiPlus, FiUnlock } from "react-icons/fi";

const WorkflowControls = ({ isLocked, onToggleLock, disabled }) => {
  const { zoomIn, zoomOut, fitView } = useReactFlow();

  const buttonClass =
    "w-10 h-10 flex items-center justify-center bg-[#161a23] border border-gray-800 text-gray-400 hover:text-[#00ff88] hover:border-[#00ff88]/50 hover:bg-[#00ff88]/10 transition-all duration-200 shadow-lg first:rounded-t-lg last:rounded-b-lg border-b-0 last:border-b";
