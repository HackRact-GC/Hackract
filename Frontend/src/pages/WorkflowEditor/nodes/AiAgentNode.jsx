...
const AiAgentNode = ({ data, selected }) => {
  ...
  return (
    <div
      className={`bg-[#0b0f19] border rounded-lg w-[300px] font-mono text-sm transition-all relative ${selected || showPresence ? "border-[#00ff88] shadow-[0_0_20px_rgba(0,255,136,0.6)]" : "border-[#00ff88]/50 shadow-[0_0_10px_rgba(0,255,136,0.3)]"}`}
    >
      {/* Presence Indicators */}
      {showPresence && (
