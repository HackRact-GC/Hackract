 ...
 */
router.post('/', restrictTo('ORG_ADMIN'), controller.send);
 ...
 *         description: List of invitations
 */
router.get('/project/:pentestId', restrictTo('ORG_ADMIN'), controller.listForProject);
 ...
 */
router.delete('/:id', restrictTo('ORG_ADMIN'), controller.revoke);
